...
public func mapAll<V, E0: EitherType, E1: EitherType where E0.LeftType == ErrorType, E1.LeftType == ErrorType>(e0: E0, _ e1: E1, @noescape transform: (E0.RightType, E1.RightType) -> V) -> Result<V> {
    return e0.flatMap { s0 in
        e1.map { transform(s0, $0) }
    }
}

public func mapAll<V, E0: EitherType, E1: EitherType, E2: EitherType where E0.LeftType == ErrorType, E1.LeftType == ErrorType, E2.LeftType == ErrorType>(e0: E0, _ e1: E1, _ e2: E2, @noescape transform: (E0.RightType, E1.RightType, E2.RightType) -> V) -> Result<V> {
    return e0.flatMap { s0 in
